...
import Participants from "../../public/icons/Participants.svg"; // Adjust the path if necessary
				...
				{tournaments.length > 0 ? (
					tournaments.map((tournament) => (
						...
						>
							...
							<div className="flex-1 p-4 rounded-md bg-[#111827] text-white transition-colors duration-500 group-hover:bg-[#FED136]">
