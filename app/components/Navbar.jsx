...
export default function Navbar() {
    return (
        ...
        <Link href='join' className="bg-slate-50 text-black active:bg-blue-400 active:dark:bg-blue-600 ml-6 dark:text-white dark:bg-gray-600 rounded p-2.5"> Join </Link>
        </nav>
    );
    }
