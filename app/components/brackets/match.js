        ...
        <div className="relative">
            ...
            >
                <div className="flex flex-col items-center">
                    <div className="flex items-center justify-between w-full mt-1">
                        {match.player1.user && (
                            <div className="flex items-center justify-between w-full">
                                <h1 className="text-md font-semibold text-gray-900">{match.player1.user.username}</h1>
                                <div className="w-8 h-8 bg-gray-100 rounded-md flex items-center justify-center px-2">
                                    <span className="text-sm font-semibold text-sunsab-yellow">{match.player1.score}</span>
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between w-full mt-1">
                        {match.player2.user && (
                            <div className="flex items-center justify-between w-full">
                                <h1 className="text-md font-semibold text-gray-900">{match.player2.user.username}</h1>
                                <div className="w-8 h-8 bg-gray-100 rounded-md flex items-center justify-center px-2">
                                    <span className="text-sm font-semibold text-sunsab-yellow">{match.player2.score}</span>
                                </div>
                            </div>
                        )}
                    </div>
            ...
            {showPopup && (
                ...
                >
                    ...
                    >
                        <p className="text-xl font-bold mb-6 text-gray-900 text-center">Match Details</p>
